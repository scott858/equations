 ...
 */
            ...
            if (__pyx_t_10 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_real) lastprivate(__pyx_v_z) lastprivate(__pyx_v_imag) lastprivate(__pyx_v_j) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) schedule(static, __pyx_t_11)
                    #endif /* _OPENMP */
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel reduction(+:__pyx_v_total) private(__pyx_t_7, __pyx_t_4, __pyx_t_5, __pyx_t_8, __pyx_t_6)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
