...
/*--- Type declarations ---*/
struct __pyx_opt_args_9integrate_c_integrate;
...
static double __pyx_f_9integrate_c_integrate(double __pyx_v_a, double __pyx_v_b, double (*__pyx_v_f)(double), struct __pyx_opt_args_9integrate_c_integrate *__pyx_optional_args) {
